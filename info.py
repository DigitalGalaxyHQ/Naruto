...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002277927856 -1002149281691 -1002285348355').split()]
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/avengerdoomsday1')
